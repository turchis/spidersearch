...
from astrosource.analyse_OLD import find_variable_stars, photometric_calculations, calibrated_photometry
from astrosource.comparison_OLD import find_comparisons, find_comparisons_calibrated, check_comparisons_files
from astrosource.detrend import detrend_data
from astrosource.eebls import plot_bls
from astrosource.identify_OLD import find_stars, gather_files
from astrosource.periodic_OLD import plot_with_period
from astrosource.plots_OLD import make_plots, make_calibrated_plots, open_photometry_files, output_files, phased_plots
